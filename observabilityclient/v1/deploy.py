...
import logging
import os
import yamlfrom osc_lib.command import command
from osc_lib.i18n import _from tripleoclient import constants
...
class ObservabilityBase(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                "Path to directory where observability ansible playbooks are being "
    ...
    def _run_playbook(self, playbook, parsed_args, tags=None):
        ...
        with utils.TempDirs() as tmpdir:
            utils.run_ansible_playbook(
                ...
                workdir='/home/stack/demo', # TODO: will be ansible base dir
                tags=tags
            )


class Discover(ObservabilityBase):
